...
public class ToolsMetric extends AbstractActionCheckBox {
	...
	public boolean isSelected(String actionCommand) {
		...
		return getCurrentGPDocument().getColumnRule().isMetric();
	}
	...
	public void actionPerformed(ActionEvent e) {
		boolean metric = !getCurrentGPDocument().getColumnRule().isMetric();
		getCurrentGPDocument().getColumnRule().setIsMetric(metric);
		getCurrentGPDocument().getRowRule() .setIsMetric(metric);
	}
