 ...
 */
public class ViewScaleZoomIn extends GPAction {
	 ...
	 */
		...
		public void actionPerformed(ActionEvent e) {
			mdiContainer.getCurrentDocument() .setResizeAction(null);
			if (getCurrentGraph().getScale() < 8) {
				// "Zero Length String passed to TextLayout constructor"
				getCurrentGPDocument().setScale(getCurrentGraph().getScale() * 2);
