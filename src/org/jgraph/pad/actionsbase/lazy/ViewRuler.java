...
public class ViewRuler extends AbstractActionCheckBox {
	...
	public void actionPerformed(ActionEvent e) {
		ruler = !ruler;
		if (ruler) {
			getCurrentGPDocument().getScrollPane() .setColumnHeaderView(getCurrentGPDocument().getColumnRule() );
			getCurrentGPDocument().getScrollPane() .setRowHeaderView(getCurrentGPDocument().getRowRule() );
		} else {
			getCurrentGPDocument().getScrollPane() .setColumnHeaderView(null);
			getCurrentGPDocument().getScrollPane() .setRowHeaderView(null);
		}
